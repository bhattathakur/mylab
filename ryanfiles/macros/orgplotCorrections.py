...
f=fileloc+'sourceCorrectionsimdir.dat'
...
pyplot.title("correction-simdir")
...
pyplot.savefig(fileloc+'correction-simdir.pdf', bbox_inches='tight')
print("\n"+fileloc+'correction-simdir.pdf created')
pyplot.clf()
...
pyplot.autoscale(enable=True,axis='y')
pyplot.title("correction-correlated-simdir")
...
pyplot.savefig(fileloc+'correctioncorrelated-simdir.pdf', bbox_inches='tight')
print("\n"+fileloc+'correctioncorrelated-simdir.pdf created')
